...
try {
    ...
    $offers = $offerManager->getActiveOffers();
...
<head>
    <meta charset="utf-8">
    <title>Tarification - Universe Security</title>
            ...
            <div class="container py-5">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Nos Tarifs</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a class="text-white" href="index.php">Accueil</a></li>
                                <li class="breadcrumb-item text-white active" aria-current="page">Tarification</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Tarification</h6>
                <h1 class="mb-5">Nos Services et Tarifs</h1>
            </div>
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="<?php echo 0.1 + ($index * 0.2); ?>s">
                            <div class="pricing-card h-100">
                                <div class="pricing-header text-center p-4">
                                    ...
                                    <h4 class="mb-3"><?php echo htmlspecialchars($offer['title']); ?></h4>
                                    <div class="pricing-price">
                                        <?php if (isset($offer['price']) && $offer['price'] > 0): ?>
                                            <span class="price-amount"><?php echo number_format($offer['price'], 0, ',', ' '); ?></span>
                                            <span class="price-currency"><?php echo htmlspecialchars($offer['currency'] ?? 'XOF'); ?></span>
                                        <?php else: ?>
                                            <span class="price-text">Sur Devis</span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="pricing-body p-4">
                                    ...
                                    <ul class="pricing-features list-unstyled">
                                        <?php if (isset($offer['features']) && !empty($offer['features'])): ?>
                                            <?php $features = explode('|', $offer['features']); ?>
                                ...
                                <div class="pricing-footer p-4 text-center">
                                    <a href="index.php#contact" class="btn btn-primary py-2 px-4">
                                        <?php echo (isset($offer['price']) && $offer['price'] > 0) ? 'Commander' : 'Demander un Devis'; ?>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <?php else: ?>
                    ...
                    <div class="col-12 text-center py-5">
                        <div class="bg-light rounded p-5">
                            ...
                            <h4 class="text-muted mb-3">Nos tarifs arrivent bientôt</h4>
                            <p class="text-muted mb-4">Nous préparons actuellement nos offres tarifaires. Contactez-nous pour un devis personnalisé.</p>
            ...
            <div class="row mt-5">
                <div class="col-12 text-center">
                    <div class="bg-light rounded p-5">
                        <h3 class="mb-3">Besoin d'un devis personnalisé ?</h3>
                        <p class="mb-4">Contactez-nous pour une évaluation gratuite de vos besoins en sécurité</p>
